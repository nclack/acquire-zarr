...
verify_and_cleanup()
{
    ...
    {
        EXPECT(s3::object_exists(group_metadata_path),
               "Object does not exist: ",
               group_metadata_path);
        std::string contents = s3::get_object_contents(group_metadata_path);
    ...
    {
        EXPECT(s3::object_exists(group_metadata_path_2),
               "Object does not exist: ",
               group_metadata_path_2);
        std::string contents = s3::get_object_contents(group_metadata_path_2);
        nlohmann::json group_metadata = nlohmann::json::parse(contents);
    ...
    {
        EXPECT(s3::object_exists(group_metadata_path_3),
               "Object does not exist: ",
               group_metadata_path_3);
        std::string contents = s3::get_object_contents(group_metadata_path_3);
        nlohmann::json group_metadata = nlohmann::json::parse(contents);
